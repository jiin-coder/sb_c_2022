    ...
    <form class="table-box-type-1" method="POST" action="../member/doJoin"
      ...
      <table>
        ...
        <tbody>
          <tr>
            <th>로그인아이디</th>
            <td><input name="loginId" class="w-96 input input-bordered" type="text" placeholder="로그인아이디"
              onkeyup="checkLoginIdDupDebounced(this);" autocomplete="off" />
              <div class="loginId-message"></div></td>
          </tr>
          <tr>
            <th>로그인비밀번호</th>
          ...
          <tr>
            <th>로그인비밀번호 확인</th>
            <td><input name="loginPwConfirm" class="w-96 input input-bordered" type="password"
              placeholder="로그인비밀번호 확인" /></td>
          </tr>
          <tr>
            <th>이름</th>
          ...
          <tr>
            <th>이메일</th>
            <td><input name="email" class="w-96 input input-bordered" type="email" placeholder="이메일" /></td>
          </tr>
          <tr>
            <th>휴대전화번호</th>
            <td><input name="cellphoneNo" class="w-96 input input-bordered" type="text" placeholder="휴대전화번호" /></td>
          </tr>
          <tr>
            <th>회원가입</th>
            <td>
